...
| --- | --- | --- |
| TASK-001 Player Session | P0 | 当前基础任务 |
| TASK-002 Online Checkpoint | P0 | 依赖 TASK-001 的在线累计任务 |
| TASK-003 Offline Finalization | P0 | 依赖 TASK-001 的终局结算任务 |
| TASK-004 Attribute Sync | P1 | 后续永久数据任务 |
| TASK-005 Attribute Purchase | P1 | 后续属性购买任务 |

## Sprint Gate

1. `TASK-001` 必须先完成 Review、Testing 和验收，才能解除 `TASK-002`、`TASK-003`、`TASK-004` 的依赖门禁。
