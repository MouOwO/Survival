...
M.rows = {
    ...
    row("item_small_polar_crystal", 1, {
        type = "ice_wraith_kill_count", required = 200,
    }, { all_attributes_flat = 1000 }),
    row("item_large_polar_crystal", 2, nil, { all_attributes_flat = 2000 }),
