...
local M = {}
M.rows = {
    { pool_id = "map", display_name = "地图抽奖", description = "N/R/SR/SSR/UR综合奖池 · 十连至少SR", ticket_content_id = "lottery_ticket", single_cost = 1, ten_cost = 10, pool_group = "map", ui_order = 1, enabled = true, review_status = "ok", notes = "UR基础概率1%；仅直接十连触发至少SR；连续十次单抽不保底。" },
