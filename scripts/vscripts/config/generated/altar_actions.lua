...
local M = {}
M.rows = {
    { action_id = "altar_endless_training", name = "无尽年轮圣殿", ability_name = "ability_enter_endless_training", ability_texture = "faceless_void_time_walk", location_id = "endless_cycle_sanctum", fallback_target_name = "challenge_04_entry", wood_cost = 0, gold_cost = 50000, gold_cost_per_second = 50000, required_rebirth_level = 10, training_room_income_multiplier = 15, target_unit_name = "building_endless_training_target", target_health = 1000000000, target_armor = 100000, target_health_regen = 100000000, prerequisite_text = "英雄10转", visible_condition = "hero_summoned==true", description = "传送至无尽年轮圣殿。英雄达到10转后解锁；每秒消耗50000金币；攻击练功建筑时攻击力与力量、敏捷、智力成长收益均为15倍。", enabled = true, source = "英雄祭坛传送" },
