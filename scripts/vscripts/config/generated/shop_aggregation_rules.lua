...
M.rows = {
    ...
    { source_id = "technology", module_name = "technology_definitions", content_type = "technology", id_field = "technology_id", name_field = "display_name", description_field = "notes", category_default = "technology", wood_cost_field = "wood_cost", gold_cost_field = "gold_cost", grant_type_default = "technology_level", icon_type_default = "ability", enabled = true, notes = "按科技等级行展示；名称和说明均来自统一科技定义表。" },
