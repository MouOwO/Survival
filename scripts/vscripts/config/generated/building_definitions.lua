...
M.rows = {
    ...
    { building_id = "building_farm", name = "人口农场", unit_name = "building_farm", max_count = 1, requires_city_level = 1, population_cost = 0, unlock_condition = "main_city_level>=1", builder_ability = "ability_build_farm", disable_after_built = false },
    ...
    { building_id = "gold_mine", name = "金矿", unit_name = "building_gold_mine", max_count = 5, requires_city_level = 3, population_cost = 2, unlock_condition = "main_city_level>=3", builder_ability = "ability_build_gold_mine", disable_after_built = false, notes = "主城3级解锁；最多5个；建造消耗2000木材，占用2人口。" },
