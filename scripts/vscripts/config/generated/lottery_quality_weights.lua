...
local M = {}
M.rows = {
    { weight_id = "map_n", pool_id = "map", quality = "n", weight = 6850, enabled = true, review_status = "ok", notes = "68.5%；为新增UR 1%从原N 69.5%扣除。" },
    ...
    { weight_id = "map_ur", pool_id = "map", quality = "ur", weight = 100, enabled = true, review_status = "ok", notes = "1%。" },
