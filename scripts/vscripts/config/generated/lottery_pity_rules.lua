...
local M = {}
M.rows = {
    { rule_id = "map_sr_ten_pull", pool_id = "map", target_quality = "sr", threshold = 10, trigger_mode = "batch_only", priority = 10, enabled = true, review_status = "ok", notes = "仅一次十连请求生效；未自然获得SR或更高品质时固定补SR，不会由保底补出UR；连续十次单抽不触发保底。" },
