...
M.rows = {
    ...
    { issue_id = "ISSUE-008", severity = "medium", affected_ids = {"tech_gold_mine_efficiency"}, issue_type = "升级费用缺失", description = "只明确效率每级+1，未提供升级金币/木材费用。", proposed_resolution = "TechnologyDefinitions中费用留空，需策划填写。" },
