...
M.rows = {
    ...
    { rule_id = "wall_engagement_slot_count", value = 4, description = "城墙同侧均匀分布的走地怪实际接敌槽位数；三个隔离墙形成四个间隔槽位", enabled = true },
    { rule_id = "wall_engagement_slot_spacing", value = 80, description = "城墙走地怪接敌槽位沿墙间距", enabled = true },
    { rule_id = "wall_engagement_normal_offset", value = 288, description = "城墙走地怪接敌槽位距墙中心的法向距离", enabled = true },
    ...
    { rule_id = "wall_engagement_debug_enabled", value = 1, description = "显示城墙接敌推荐位置和地面怪Hull调试图形（0关闭1开启）", enabled = true },
    { rule_id = "wall_engagement_debug_z_offset", value = 96, description = "城墙接敌和地面怪Hull调试图形相对地面的抬高高度", enabled = true },
    { rule_id = "wall_engagement_debug_duration", value = 0.6, description = "城墙接敌和地面怪Hull调试图形单次绘制持续时间", enabled = true },
    { rule_id = "wall_collision_barrier_count", value = 3, description = "每个方位的透明隔离墙数量；三个隔离墙形成四个间隔槽位", enabled = true },
    { rule_id = "wall_collision_barrier_spacing", value = 80, description = "同一方位透明隔离墙之间的切向间距", enabled = true },
    { rule_id = "wall_collision_barrier_hull_radius", value = 32, description = "透明隔离墙代理的真实Hull半径", enabled = true },
    { rule_id = "wall_collision_normal_offset", value = 288, description = "四个方位透明隔离墙距城墙中心的基础法向距离", enabled = true },
    { rule_id = "wall_collision_offset_x", value = 0, description = "透明隔离墙沿局部切向的统一偏移", enabled = true },
    { rule_id = "wall_collision_offset_y", value = 0, description = "透明隔离墙沿局部法向的统一偏移；可单独调整Y方向偏差", enabled = true },
    { rule_id = "wall_collision_up_offset_x", value = 0, description = "上方隔离墙组的切向偏移", enabled = true },
    { rule_id = "wall_collision_up_offset_y", value = 0, description = "上方隔离墙组的法向偏移", enabled = true },
    { rule_id = "wall_collision_down_offset_x", value = 0, description = "下方隔离墙组的切向偏移", enabled = true },
    { rule_id = "wall_collision_down_offset_y", value = 0, description = "下方隔离墙组的法向偏移", enabled = true },
    { rule_id = "wall_collision_left_offset_x", value = 0, description = "左方隔离墙组的切向偏移", enabled = true },
    { rule_id = "wall_collision_left_offset_y", value = 0, description = "左方隔离墙组的法向偏移", enabled = true },
    { rule_id = "wall_collision_right_offset_x", value = 0, description = "右方隔离墙组的切向偏移", enabled = true },
    { rule_id = "wall_collision_right_offset_y", value = 0, description = "右方隔离墙组的法向偏移", enabled = true },
