...
M.rows = {
    ...
    { rule_id = "wave_ground_monster_hull_radius", value = 32, description = "正式地面波次怪统一基础碰撞半径", enabled = true },
    ...
    { rule_id = "dev_wall_health", value = 9999999999, description = "输入dev后城墙的开发模式最大生命和当前生命", enabled = true },
