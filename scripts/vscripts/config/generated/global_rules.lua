...
M.rows = {
    ...
    { rule_id = "wall_engagement_slot_count", value = 4, description = "城墙同侧均匀分布的走地怪接敌槽位数", enabled = true },
    { rule_id = "wall_engagement_slot_spacing", value = 80, description = "城墙走地怪接敌槽位沿墙间距；收拢至墙体中段且小于四个地面怪Hull直径之和以阻止第五只插入", enabled = true },
    { rule_id = "wall_engagement_normal_offset", value = 384, description = "城墙走地怪接敌槽位距墙中心的法向距离", enabled = true },
    { rule_id = "wall_engagement_arrival_distance", value = 24, description = "走地怪视为到达城墙接敌槽位的距离", enabled = true },
    { rule_id = "wall_engagement_departure_distance", value = 48, description = "已接敌走地怪重新离开槽位并恢复移动的距离", enabled = true },
    { rule_id = "wall_engagement_queue_spacing", value = 160, description = "超出接敌槽位的走地怪向外排队间距", enabled = true },
