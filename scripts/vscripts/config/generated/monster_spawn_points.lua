...
local M = {}
M.rows = {
    { spawn_point_id = "spawn_wild_boss", hammer_target_name = "monsterorn", current_entity_class = "info_player_start_dota", recommended_entity_class = "info_target", team_name = "DOTA_TEAM_BADGUYS", encounter_group = "wild_boss", rebirth_level = 0, archetype_id = "wild_boss_common", enabled = true, notes = "代码按targetname查找，因此当前地图可继续测试；正式地图建议把实体类改成info_target并保留名称。" },
