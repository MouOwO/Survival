...
M.rows = {
    ...
    { ability_name = "ability_build_gold_mine", building_id = "building_gold_mine", visible_condition = "main_city_level>=3", purchasable_condition = "building_count(building_gold_mine)<1", disable_after_built = true, client_block_when_disabled = true, disabled_text = "主城未到3级或金矿已建造" },
