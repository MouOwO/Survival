...
M.rows = {
    ...
    { skill_id = "lumberjack_personality_heavy_hand", ability_name = "ability_lumberjack_personality_heavy_hand", name = "手很重", description = "每次采集有1%概率直接减少资源树最大生命值的1%", effect_type = "tree_damage_chance_pct", effect_value = 1, enabled = true, source = "伐木工超级合成", notes = "超级伐木工LV4" },
    { skill_id = "lumberjack_personality_cheer", ability_name = "ability_lumberjack_personality_cheer", name = "啦啦队", description = "为所属玩家英雄、箭塔和所有伐木工增加10%攻速，多个可叠加", effect_type = "owner_attack_speed_pct", effect_value = 10, enabled = true, source = "伐木工超级合成", notes = "超级伐木工LV5" },
    ...
    { skill_id = "lumberjack_personality_efficiency", ability_name = "ability_lumberjack_personality_efficiency", name = "效率", description = "当前综合采集数量增加30%", effect_type = "wood_total_bonus_pct", effect_value = 30, enabled = true, source = "伐木工超级合成", notes = "超级伐木工LV7" },
