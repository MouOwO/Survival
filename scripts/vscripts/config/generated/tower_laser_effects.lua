...
M.rows = {
    ...
    { effect_key = "laser_lv05:tower_laser_death_prophet_brightshroud", skill_id = "laser_lv05", model_asset_id = "tower_laser_death_prophet_brightshroud", particle_name = "particles/units/heroes/hero_tinker/tinker_laser.vpcf", beam_mode = "segmented", attack_point = 0, beam_update_interval = 0.03, visual_refresh_interval = 0.12, visual_segment_duration = 0.18, source_offset_z = 160, target_offset_z = 70, damage_increment_pct = 5, max_damage_multiplier = 5, enabled = true, notes = "光明尸衣之魂阶段完整沿用已验证的普通激光塔Tinker Laser视觉与分段生命周期。" },
}
M.by_id = {}
