...
M.rows = {
    ...
    { stage_id = "wall_pending", stage_order = 10, trigger_state = "wall_not_built", ability_name = "ability_survival_rogue_reward", slot_order = 2, required_city_level = 0, max_building_count = 0, disable_after_hero_summoned = false, enabled = true, notes = "开局一次性肉鸽奖励；成功打开后永久移除。" },
