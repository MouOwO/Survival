...
M.rows = {
    ...
    { stage_id = "city_built", stage_order = 30, trigger_state = "main_city_built", ability_name = "ability_build_farm", slot_order = 3, required_city_level = 1, building_id = "building_farm", max_building_count = 0, disable_after_hero_summoned = false, enabled = true, notes = "主城完成后解锁人口农场，可重复建造。" },
    ...
    { stage_id = "city_built", stage_order = 30, trigger_state = "main_city_built", ability_name = "ability_build_gold_mine", slot_order = 5, required_city_level = 3, building_id = "gold_mine", max_building_count = 5, disable_after_hero_summoned = false, enabled = true, notes = "主城3级后显示，最多建造5座金矿。" },
}
M.by_id = {}
