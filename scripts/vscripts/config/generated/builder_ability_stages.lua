...
M.rows = {
    ...
    { stage_id = "wall_pending", stage_order = 10, trigger_state = "wall_not_built", ability_name = "ability_survival_rogue_reward", slot_order = 7, required_city_level = 0, max_building_count = 0, disable_after_hero_summoned = false, enabled = true, notes = "开局天赋；固定G键并独立于六个建筑槽。选择后保留入口并显示所选天赋。" },
