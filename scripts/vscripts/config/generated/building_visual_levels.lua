...
M.rows = {
    ...
    { visual_id = "hero_altar_visual_lv01", building_id = "building_hero_altar", level = 1, model_name = "models/props_structures/tower_good4.vmdl", model_scale = 0.34, model_yaw = 0, enabled = true, notes = "召唤祭坛指定模型" },
}
M.by_id = {}
