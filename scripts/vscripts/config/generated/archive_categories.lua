...
M.rows = {
    ...
    { category_id = "map_level", display_name = "地图等级", renderer = "placeholder", sort_order = 40, enabled = false },
    { category_id = "work", display_name = "上班福利", renderer = "placeholder", sort_order = 50, enabled = false },
