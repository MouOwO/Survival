...
M.rows = {
    ...
    skill({
        ...
        level_text = {
            "普通攻击命中时，12%概率在目标位置生成400范围毒云，持续5秒；第1至第5秒各造成一次触发时全属性总和×1纯粹伤害。同一英雄的新毒云会替换旧毒云。",
    ...
    skill({
        ...
        level_text = {
            "普通攻击命中时有15%概率从攻击者位置向目标方向释放龙卷风。龙卷风以500速度移动3秒，在生成时及第1、2秒实时读取全属性，对中心300范围造成全属性×2纯粹伤害。",
            "完整继承等级1效果，无额外变化。",
