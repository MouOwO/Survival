...
M.rows = {
    ...
    skill({
        skill_id = "proto_echo_slash", display_name = "回音重斩", icon_name = "magnataur_shockwave",
        max_level = 5,
        trigger_chance = { 0.12, 0.15, 0.15, 0.15, 0.15 },
        damage_multiplier = { 1.00, 1.00, 1.00, 1.00, 1.00 },
        slash_width = { 200, 200, 200, 200, 200 },
        slash_count = { 1, 2, 3, 3, 4 },
        slash_interval = { 0, 0.10, 0.10, 0.10, 0.10 },
        slash_duration = { 1.00, 1.00, 1.00, 1.00, 1.00 },
        random_damage_min_pct = { 0, 0, 0, 0, 5 },
        random_damage_max_pct = { 0, 0, 0, 0, 20 },
        level_text = {
            "普通攻击命中时有12%概率从英雄触发位置朝目标当时位置方向发射1道弧形斩。斩击总宽200，距离等于英雄攻击射程，1秒走完全程；路径内所有敌人受到触发时全属性×1纯粹伤害。",
            "触发概率提高至15%，斩击数量增加至2道，每道间隔0.1秒。每道独立命中并造成完整伤害。",
            "斩击数量增加至3道，其他效果不变。",
            "完整继承等级3效果，无额外变化。",
            "斩击数量增加至4道；每道斩击分别随机提高5%至20%伤害。",
        },
    }),
    skill({
        ...
        trigger_chance = { 0.12, 0.12, 0.12, 0.12, 0.12 },
        damage_multiplier = { 3.00, 3.00, 3.00, 3.00, 3.00 },
        stunned_damage_multiplier = { 6.00, 6.00, 6.00, 6.00, 6.00 },
        move_speed = { 500, 500, 500, 500, 500 },
        rock_width = { 150, 250, 250, 250, 250 },
        stun_chance = { 0, 0, 0.30, 0.30, 0.30 },
        stun_duration = { 0, 0, 1.0, 1.0, 1.0 },
        first_hit_explosion_radius = { 0, 0, 0, 0, 300 },
        first_hit_explosion_multiplier = { 0, 0, 0, 0, 3.00 },
        level_text = {
            "普通攻击命中时有12%概率从英雄触发位置向目标当时位置释放滚石。滚石以500速度直线移动且不追踪，总宽150；路径命中造成触发时全属性×3纯粹伤害，对命中前已眩晕的单位伤害翻倍。到达固定终点后仅播放无伤害爆炸。",
            "滚石总宽提高至250，其他效果不变。",
            "每个路径真实命中的敌人在伤害结算后独立有30%概率眩晕1秒。",
            "完整继承等级3效果，无额外变化。",
            "滚石首次真实命中敌人时，以命中位置为中心对300范围额外造成全属性×3纯粹伤害；每个范围目标若在结算前已眩晕则伤害翻倍，首个敌人也会承受该额外伤害。范围伤害不触发眩晕，滚石继续穿透至终点。",
        },
    }),
    skill({
