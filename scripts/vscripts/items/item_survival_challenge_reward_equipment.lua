...
function item_survival_challenge_reward:Claim(caster)
    ...
    -- The native pickup occupies a visible equipment slot. Free that slot,
    -- grant the authoritative material, then let the equipment service create
    -- its persistent shell there. The recipe transaction removes that shell
