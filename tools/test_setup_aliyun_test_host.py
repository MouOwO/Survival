...
class BootstrapTests(unittest.TestCase):
    def test_broken_copied_venv_is_preserved_rebuilt_and_then_reused(self):
        ...
        with tempfile.TemporaryDirectory(prefix="goufayu bootstrap ") as folder:
            ...
            # A real venv launcher depends on pyvenv.cfg; a copied base python.exe
            # can find this PC's installation and falsely make the fixture healthy.
            created = subprocess.run([sys._base_executable, "-m", "venv", "--without-pip", str(venv)],
