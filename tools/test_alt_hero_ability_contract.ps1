...
Check ($heroSkills.Contains("local function desired_ability_names(state)")) "ALT_FIX_SKILL_SYNC_ORDER_MISSING"
Check ($heroSkills.Contains("local function remove_unmanaged_abilities(state, desired)")) "ALT_FIX_SKILL_SYNC_NATIVE_CLEANUP_MISSING"
Check ($heroSkills.Contains("local function ability_layout_matches(unit, desired)")) "ALT_FIX_SKILL_SYNC_LAYOUT_CHECK_MISSING"
Check ($heroSkills.Contains("local function rebuild_ability_layout(state, desired)")) "ALT_FIX_SKILL_SYNC_LAYOUT_REBUILD_MISSING"
Check ($heroSkills.Contains("ability:GetCooldownTimeRemaining()")) "ALT_FIX_SKILL_SYNC_COOLDOWN_CAPTURE_MISSING"
Check ($heroSkills.Contains("local ability = state.unit:AddAbility(name)")) "ALT_FIX_SKILL_SYNC_AUTHORITATIVE_ADD_ORDER_MISSING"
Check ($heroSkills.Contains("ability:StartCooldown(remaining)")) "ALT_FIX_SKILL_SYNC_COOLDOWN_RESTORE_MISSING"
