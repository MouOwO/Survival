...
for(const [cls,props]of Object.entries(lighting)){for(const k of Object.keys(props))if(k.endsWith('map_texture')||k==='height_fog_textureopacity')delete props[k];if(cls==='ent_dota_lightinfo'){for(const time of ['day','night'])Object.assign(props,{['color_'+time]:'132 151 211 255',['light_scale_'+time]:'1.7',['ambient_color_'+time]:'95 112 164 255',['ambient_scale_'+time]:'.72',['fog_start_'+time]:'20000',['fog_end_'+time]:'40000',['fog_height_'+time]:'0',['fow_darkess_'+time]:'1',['light_direction_'+time]:'66 330 0'});props.farz_override='45000';}else Object.assign(props,{color:'132 151 211 255',lightscale:'1.7',ambientcolor1:'95 112 164 255',ambientscale1:'.72',ambientcolor2:'76 88 132 255',ambientscale2:'.2',ambientcolor3:'76 88 132 255',groundscale:'.2',fow_darkness:'1'});entity(cls,NAME+'_'+cls,[0,0,2500],props,'66 330 0');}
entity('env_tonemap_controller','daylight_exposure',[0,0,0],{minexposure:'.65',maxexposure:'.95',master:'1',rate:'2'});
