...
const ocean=water.replace(/"g_vWaterFogColor"\s*"[^"]+"/,'"g_vWaterFogColor" "[0.10 0.22 0.22 1]"').replace(/"g_flWaterDepth"\s*"[^"]+"/,'"g_flWaterDepth" "120"').replace(/"g_flBumpStrength"\s*"[^"]+"/,'"g_flBumpStrength" "0.65"');
