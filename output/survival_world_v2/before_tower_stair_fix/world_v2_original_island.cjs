...
function sample(key,x,y,original,edgeVertical=false){
 ...
 if((approach(x,y)||isShallow||innerBankTile(x,y))&&/^objects(Prop|Plant|Tree)Type$/.test(key))return '0';
...
module.exports={center,pivot,locate,shallow,height,sample,transform,arrays,originalLand,levels,approach,replacedStairTile,preserved,worldPoint,innerBankTile,channelHalfWidth};
