...
const islandBankArt={outward:512,waterWidth:1152,waterLength:4608,taperStart:1152,taperEnd:2048,gateWaterWidth:640,stairWidth:576,banks:[],gardens:[]};
...
for(let q=0;q<4;q++)for(const side of [-1,1]){
 ...
 for(let k=0;k<knots.length-1;k++){
  const a=knots[k],b=knots[k+1],outline=[[a,edge(a)],[b,edge(b)],[b,896],[a,896]].map(v=>pt(...v));
