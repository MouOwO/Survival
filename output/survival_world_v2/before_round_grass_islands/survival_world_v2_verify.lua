...
do local a=GetGroundHeight(Vector(2560,2688,1000),nil);local l=GetGroundHeight(Vector(256,3584,1000),nil);local r=GetGroundHeight(Vector(256,1792,1000),nil);print('[WORLD_V2_ISLAND_LEVELS]',0,a,l,r,(math.abs(a-640)<4 and math.abs(l-768)<4 and math.abs(r-768)<4) and 'PASS' or 'FAIL') end
...
do local a=GetGroundHeight(Vector(-1152,6400,1000),nil);local l=GetGroundHeight(Vector(-2048,4096,1000),nil);local r=GetGroundHeight(Vector(-256,4096,1000),nil);print('[WORLD_V2_ISLAND_LEVELS]',1,a,l,r,(math.abs(a-640)<4 and math.abs(l-768)<4 and math.abs(r-768)<4) and 'PASS' or 'FAIL') end
...
do local a=GetGroundHeight(Vector(-4864,2688,1000),nil);local l=GetGroundHeight(Vector(-2560,1792,1000),nil);local r=GetGroundHeight(Vector(-2560,3584,1000),nil);print('[WORLD_V2_ISLAND_LEVELS]',2,a,l,r,(math.abs(a-640)<4 and math.abs(l-768)<4 and math.abs(r-768)<4) and 'PASS' or 'FAIL') end
...
do local a=GetGroundHeight(Vector(-1152,-1024,1000),nil);local l=GetGroundHeight(Vector(-256,1280,1000),nil);local r=GetGroundHeight(Vector(-2048,1280,1000),nil);print('[WORLD_V2_ISLAND_LEVELS]',3,a,l,r,(math.abs(a-640)<4 and math.abs(l-768)<4 and math.abs(r-768)<4) and 'PASS' or 'FAIL') end
