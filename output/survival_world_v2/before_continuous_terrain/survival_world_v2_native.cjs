...
function heightAt(x,y){const a=at(x,y);if(a)return a.material===M.water&&!a.shallow?3:Math.max(1,Math.ceil(a.z/128));const noise=(Math.sin(x/1100+y/1600)+Math.cos(y/1000-x/1400)+2)/4;return 5+Math.floor(noise*5);}
