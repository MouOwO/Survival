(function () {
    ...
    if(Game.AddCommand&&!cfg.HandoffCommandsV9){
        cfg.HandoffCommandsV9=true;
        Game.AddCommand("handoff_dump_v9",function(){if(cfg.HandoffDump)cfg.HandoffDump();},"Read-only inspection of isolated handoff HUD",0);
