(function () {
    ...
    if(Game.AddCommand){
        ...
        Game.AddCommand("handoff_select"+suffix,function(id){var unit=Number(id);if(unit>=0&&Entities.IsValidEntity(unit)&&Entities.GetUnitName(unit)){GameUI.SelectUnit(unit,false);GameUI.SetCameraTarget(unit);$.Schedule(.5,function(){GameUI.SetCameraTarget(-1);});}},"Select an existing test entity",0);
