(function () {
    ...
    cfg.LotteryHandoff={
        ...
        Buttons:function(selected,waiting){quality(p("LHTenQuality"),waiting?null:tenRule(selected&&selected.pity));},
    ...
    if(typeof Game!=="undefined"&&Game.AddCommand){
        ...
        $.Msg("[LOTTERY_HANDOFF_READY] version=ef48d27640 commands="+stamp);
    }
})();
